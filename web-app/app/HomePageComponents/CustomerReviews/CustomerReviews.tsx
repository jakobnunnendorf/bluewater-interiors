...
function CustomerReviews() {
  ...
  return (
    <div className="relative w-full py-24">
      <h2 className="bg-gradient-to-r from-orange-200 via-orange-400 to-orange-600 bg-clip-text pb-4 pt-16 text-center font-fat text-6xl font-bold text-transparent">
        What our Customers say
      </h2>
      <h3 className="pb-16 text-center font-fat text-4xl font-bold opacity-65">
