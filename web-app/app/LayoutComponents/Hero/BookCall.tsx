    ...
    <div className="relative flex flex-col py-8 md:block md:w-52">
      <div className="flex h-full items-center justify-center">
        <Link href="https://calendly.com/jakobnunnendorf/call">
          <div
            className={`mx-auto h-fit w-fit rounded-full border border-${color ? color : "blue-400"} px-4 py-4 shadow-xl md:my-auto md:mt-0`}
          >
            <h3
              className={`font-fat leading-3 text-${color ? color : "blue-400"}`}
            >
              Book a call
            </h3>
          </div>
